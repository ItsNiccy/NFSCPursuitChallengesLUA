h_AA3E9D36 = function(param0, param1, param2)
    ...
    param1.SpeedKmh = Game.GetSimableSpeedKmh(param1.Element)
	if param1.SpeedKmh >= param0.ThreshholdSpeed then
        RaceStatus:SetHasBeenWon(true)
        param2.PlayerHasWon = true
        Game.NotifyRaceFinished()
        ChangeState("raceover")
    elseif param1.SpeedKmh < param0.ThreshholdSpeed then
